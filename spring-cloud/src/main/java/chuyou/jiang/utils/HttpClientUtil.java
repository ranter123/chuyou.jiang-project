...
public class HttpClientUtil {
    public static String doGet(String url, Map<String, String> headers) {
        ...
        try {
            ...
            RequestConfig requestConfig = RequestConfig.custom().setConnectTimeout(10000)// 连接主机服务超时时间
                    .setConnectionRequestTimeout(150000)// 请求超时时间
    ...
    public static String doPost(String url, Map<String, String> headers, Map<String, Object> paramMap) {
        ...
        RequestConfig requestConfig = RequestConfig.custom().setConnectTimeout(10000)// 设置连接主机服务超时时间
                ...
                .setSocketTimeout(300000)// 设置读取数据连接超时时间
                .build();
        // 为httpPost实例设置配置
    ...
    public static String doPost(String url, Map<String, String> headers, String object) throws Exception{
        CloseableHttpClient httpClient = null;
        CloseableHttpResponse httpResponse = null;
        String result = "";
        // 创建httpClient实例
...
//        httpPost.addHeader("Content-Type", "application/x-www-form-urlencoded");
    ...
    public static String doPost2(String url, Map<String, String> headers, String object) throws Exception{
        CloseableHttpClient httpClient = null;
        CloseableHttpResponse httpResponse = null;
        String result = "";
        // 创建httpClient实例
